...
| Next decision | [AI-02.17's staging actual-evidence operation](./ai-02.17-staging-actual-evidence-decision.md), [AI-02.18](./ai-02.18-preview-route-attestation-closeout.md) and [AI-02.20](./ai-02.20-proxy-route-attestation-closeout.md) are all closed. AI-02.20 resolved the earlier proxy attribution but did not receive a success receipt. CAT-00.11 is exact-main verified. [CAT-00.12](./cat-00.12-github-evidence-read-operator-decision.md) consumed its one disposable identity and stopped fail-closed at its first GET attempt without an admissible response or receipt; the token was immediately revoked. | Any replacement AI staging operation needs a new product decision, new bounded authority record and fresh preconditions; it cannot retry any consumed proof. CAT-00.12 cannot be retried or treated as CI/protection evidence. A future external-evidence route needs a fresh decision, fresh scope and fresh containment; it never authorizes an automatic SEC request. |
