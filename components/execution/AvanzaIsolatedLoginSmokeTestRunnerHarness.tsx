import {
  ...
  type AvanzaIsolatedLoginSmokeTestRunnerFixture,
} from "@/lib/avanza-isolated-login-smoke-test-runner-fixtures";

type AvanzaIsolatedLoginSmokeTestRunnerHarnessProps = {
  fixtures?: readonly AvanzaIsolatedLoginSmokeTestRunnerFixture[];
};
...
export function AvanzaIsolatedLoginSmokeTestRunnerHarness({
  fixtures = avanzaIsolatedLoginSmokeTestRunnerFixtures,
}: AvanzaIsolatedLoginSmokeTestRunnerHarnessProps) {
  return (
    <section className="grid gap-4 rounded-md border border-white/10 bg-black/20 p-3">
      <div>
        ...
        <h3 className="mt-3 text-sm font-semibold text-zinc-100">
          Hard-gated runner fixtures
        </h3>
        <p className="mt-2 text-xs leading-5 text-zinc-400">
          Static safe reports only. The runner calls injected dependencies only
          after local-dev, manual terminal, env opt-in, non-CI, and safety gates
          pass. This route does not run the smoke test.
        </p>
      </div>
              ...
              <dl className="mt-3 grid gap-2 text-xs sm:grid-cols-2 lg:grid-cols-4">
                {[
                  ...
                  [
                    ...
                    formatBoolean(report.navigationToAvanzaLoginAttempted),
                  ],
                  [
                    "loginSubmitAttempted",
                    formatBoolean(report.loginSubmitAttempted),
                  ],
                  ...
                  ["runnerEnabled", formatBoolean(report.runnerEnabled)],
                  ...
                  [
                    ...
                    formatBoolean(report.canNavigateToAvanzaLogin),
                  ],
