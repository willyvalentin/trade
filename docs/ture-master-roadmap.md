...
| CAT-00.10 GitHub evidence read-plan | Draft provider-free request-plan for the future CAT-00 evidence binder | It fixes a future least-privilege identity requirement and five GET-only GitHub readback shapes, but makes no request, reads no environment, has no credential, policy, runtime, deployment, broker or production authority. |
