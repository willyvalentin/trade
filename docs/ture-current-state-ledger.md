...
- AI-02.18 is also closed: one dedicated preview-route request was rejected
  with HTTP 401 by preview access control before the temporary function ran.
