...
| REL-00 CI-B1 taxonomy | CI-B0 is verified on exact main `8127c4d2…` after PR #290; the six-shard Ready/main CI model remains unchanged | Build the source-only, fail-closed CI-B1 taxonomy without changing the workflow; CI-B7 activation needs a separately authorized required-check/branch-protection decision |
