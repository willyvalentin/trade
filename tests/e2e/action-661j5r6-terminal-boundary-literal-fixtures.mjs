...
export const ACTION_661J5R6_TERMINAL_LITERAL_FIXTURES = deepFreeze({
  fixture_version: "action_661j5r6_terminal_boundary_literal_fixtures_rebuild_v1",
  baseline_manifest_sha256:
    "7d5853d38167f16aea625331e8a1bf966df99b1dd8252f0f7102a5b6c8ed93ad",
  baseline_history_inventory: baseline,
  incident_or_duplicate_versions: ["20260724003000", "20260726000000"],
  acl_state_variants: ["unknown_table_acl", "column_acl"],
  scenarios: {
    duplicate_containment_history: {
      scenario_id: "duplicate_containment_history",
      expected_history_inventory: [...baseline, duplicate].sort((left, right) =>
        left.version.localeCompare(right.version),
      ),
      expected_history_inventory_digest:
        "06eb7a929fb87859f4230b2a3af0f748556e50eb0f19329fa278c3e82acd6660",
      expected_target_acl: null,
      selected_acl_state: null,
      selected_history: duplicate,
      ...
      precondition_reference_digest:
        "70f6955bb49fba3125ab8249abc831bf5b7645c87e443c7a7be9ed73487a3786",
    },
    unknown_acl_state: {
      ...
      expected_target_acl: unknownAcl,
      ...
      precondition_reference_digest:
        "539b2b98cf473e72e78bad5847bbf21a10780d1cedf70325caaae9518efd4f0f",
    },
  },
});
