...
export const TWELVE_SHARD_AGGREGATE_VERSION =
  "action_661j5r5_twelve_shard_aggregate_rebuild_v1";
...
function normalizedFiles(historicalFiles, relationStateFiles, historyFiles) {
  if (
...
export function buildTwelveShardAggregateRebuildV1({
  historical_files,
  history_files,
  ...
  const projection = {
    aggregate_version: TWELVE_SHARD_AGGREGATE_VERSION,
    decision: "certified",
...
export function verifyTwelveShardAggregateRebuildV1(
  aggregate,
  inputs,
) {
  assertClosed(aggregate, FIELDS);
  const expected = buildTwelveShardAggregateRebuildV1(inputs);
...
export function persistTwelveShardAggregateRebuildV1({
  aggregate,
  historical_files,
  history_files,
  output_path,
  ...
  verifyTwelveShardAggregateRebuildV1(aggregate, {
    historical_files,
    history_files,
    relation_state_files,
  });
  ...
  try {
    ...
    verifyTwelveShardAggregateRebuildV1(readback, {
      historical_files,
      history_files,
      relation_state_files,
    });
