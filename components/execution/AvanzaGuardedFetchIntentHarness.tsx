import {
  ...
  type AvanzaGuardedFetchIntentFixture,
} from "@/lib/avanza-guarded-fetch-intent-fixtures";

type AvanzaGuardedFetchIntentHarnessProps = {
  fixtures?: readonly AvanzaGuardedFetchIntentFixture[];
};
...
export function AvanzaGuardedFetchIntentHarness({
  fixtures = avanzaGuardedFetchIntentFixtures,
}: AvanzaGuardedFetchIntentHarnessProps) {
  return (
      ...
      <div>
        <div className="flex flex-wrap gap-2">
          {[
            ...
            "fetch_intent_ready_internal_disabled remains disabled/internal-only",
          ].map((copy) => (
            <span
        ...
        <p className="mt-2 text-xs leading-5 text-zinc-400">
          ...
          internal/dev-only guarded fetch intent model output and does not read
            ...
            >
              ...
              <dl className="mt-3 grid gap-2 text-xs sm:grid-cols-2 lg:grid-cols-4">
                {[
                  ...
                  [
                    "fetchIntentEnabled",
                    formatBoolean(result.fetchIntentEnabled),
                  ],
                  [
                    "canCreateFetchIntent",
                    formatBoolean(result.canCreateFetchIntent),
                  ],
