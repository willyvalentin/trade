...
- Final pre-live review preserves the manual approval boundaries and does not expand them into a live run.
...
- Added final harness local simulation after the manual approval message/capture chain.
- Result status: `first_real_avanza_fill_only_poc_final_real_browser_fill_only_run_harness_simulation_added`.
- The simulation does not expand approval into a live run.
