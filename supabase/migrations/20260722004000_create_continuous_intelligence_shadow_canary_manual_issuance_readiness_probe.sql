create or replace function public.read_continuous_intelligence_shadow_canary_manual_issuance_readiness()
returns table (
...
revoke all on function public.read_continuous_intelligence_shadow_canary_manual_issuance_readiness() from public, anon, authenticated;
grant execute on function public.read_continuous_intelligence_shadow_canary_manual_issuance_readiness() to service_role;

comment on function public.read_continuous_intelligence_shadow_canary_manual_issuance_readiness() is
  'Action 589 read-only issuance readiness probe. It inspects schema, signatures, permissions, and active issuance guards without generating credentials or mutating durable state.';
