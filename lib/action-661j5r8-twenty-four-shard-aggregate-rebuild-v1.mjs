...
export const TWENTY_FOUR_SHARD_AGGREGATE_VERSION =
  "action_661j5r8_twenty_four_shard_aggregate_rebuild_v1";
...
export function buildTwentyFourShardAggregateRebuildV1({
  ...
  const projection = {
    aggregate_version: TWENTY_FOUR_SHARD_AGGREGATE_VERSION,
    decision: "certified",
...
export function verifyTwentyFourShardAggregateRebuildV1(
  aggregate,
  inputs,
) {
  assertClosed(aggregate, FIELDS);
  const expected = buildTwentyFourShardAggregateRebuildV1(inputs);
...
export function persistTwentyFourShardAggregateRebuildV1({
  aggregate,
  column_acl_policy_files,
  rpc_append_only_files,
  historical_files,
  ...
  verifyTwentyFourShardAggregateRebuildV1(aggregate, {
    column_acl_policy_files,
    rpc_append_only_files,
    historical_files,
    history_files,
  ...
  try {
    ...
    verifyTwentyFourShardAggregateRebuildV1(readback, {
      column_acl_policy_files,
      rpc_append_only_files,
      historical_files,
      history_files,
