...
- Final pre-live review includes the manual run setup simulation as passed prerequisite evidence.
...
- No credential/session handling or live Avanza action was performed.
...
- Added final harness local simulation above the manual run setup simulation.
- Result status: `first_real_avanza_fill_only_poc_final_real_browser_fill_only_run_harness_simulation_added`.
- Operator/manual-login/account/instrument proof remains modeled and required; no live Avanza access was performed.
