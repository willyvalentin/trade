        ...
        {activeTab === "Statistics" && (
          <section className="trade-statistics-section space-y-6">
            ...
            <StatisticsDashboardPanel
              ...
              recommendationPerformance={recommendationPerformanceStatistics}
              recommendationPerformanceJson={
                recommendationPerformanceStatisticsJsonText
              }
...
function StatisticsDashboardPanel({
  ...
  dashboard: StatisticsDashboard;
  recommendationPerformance: RecommendationPerformanceStatistics;
  recommendationPerformanceJson: string;
    ...
    <div className="space-y-5">
      ...
      {isLoading ? (
        ...
        <>
          ...
          <RecommendationPerformanceStatisticsPanel
            statistics={recommendationPerformance}
            statisticsJson={recommendationPerformanceJson}
          />
