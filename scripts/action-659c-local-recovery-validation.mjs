...
const paths = {
  ...
  recovery: "supabase/migrations/20260724003000_repair_contained_trading_data_access_acl_rls.sql",
  bundle: "scripts/action-659b-apply-20260724003000.sql",
  containmentReadback: "scripts/action-654-production-containment-readback.sql",
  recoveryReadback: "scripts/action-659b-production-recovery-readback.sql",
};
const expectedDigests = {
  recovery: "bde7343841dddc2f36ebd9fe017422c9803ff594a310920b3235e42bc4c00229",
  bundle: "6de0fd3c18ebe3dd38fb7ae6a373436c3ba371b6e262c59767122649899742e2",
  recoveryReadback: "6f52b987c938276b55af54fc1e0e051997ebc966c9200dfdb5cb1430b74b99df",
};
...
async function reset() {
  ...
  sql("create extension if not exists pgcrypto; create role anon login; create role authenticated login; create role service_role login bypassrls; create schema supabase_migrations; create table supabase_migrations.schema_migrations(version text primary key, statements text[] not null, name text not null);");
...
const failures = [
  ...
  ["extra_partitioned_public_table", "create table public.action_659c_partitioned_scope(id integer) partition by range (id); create table public.action_659c_partitioned_scope_part partition of public.action_659c_partitioned_scope for values from (0) to (10); grant select on public.positions to anon;"],
...
const unknownDriftFailures = [
  ["extra_scope_table", "create table public.action_659c_unexpected_scope(id bigint); grant select on public.positions to anon;"],
  ["extra_scope_table_source", "create table public.action_659c_unexpected_scope(id bigint); grant select on public.positions to anon;", "source"],
