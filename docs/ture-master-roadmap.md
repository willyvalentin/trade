...
| REL-00 CI-B0 baseline | Source-only baseline and charter phase after the qualified Milestone B closeout; the six-shard Ready/main CI model is frozen at protected main `7814f677…` | Build deterministic CI-B1 through CI-B6 evidence without changing the workflow; CI-B7 activation needs a separately authorized required-check/branch-protection decision |
