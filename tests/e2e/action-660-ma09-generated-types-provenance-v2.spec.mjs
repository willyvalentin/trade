...
const EXPECTED_SOURCES = new Map([
  [receiptPath, "a98e1af29da44f3d643aa09dbc1878ff225378bc9d52b94172011c09a82c69ae"],
  ["scripts/action-660-ma09-read-only-catalog.sql", "8e63c7515672e9d483a6b79d70ba1b632ccc8fc2ac7fb783ee848c8d68dac3fd"],
...
const RECEIPT_SHA256 = "a98e1af29da44f3d643aa09dbc1878ff225378bc9d52b94172011c09a82c69ae";
...
function validateReceipt(candidate) {
  try {
    ...
    if (candidate.contract_version !== "trade.action660.ma09.catalog-typegen-evidence.v2" || candidate.observed_at !== "2026-08-11T18:27:48Z") return false;
...
function validateProvenance(candidate, catalogReceipt = receipt, reader = readRepoFile) {
  try {
    ...
    if (!exactKeys(candidate.delivery, ["current_main_commit", "current_main_tree", "stacked_base_commit", "stacked_base_tree", "stacked_base_pr", "gate", "pre_delivery_verified_count", "post_delivery_candidate_count", "total_gate_count", "closure_conditions"]) || candidate.delivery.current_main_commit !== "490e3607d1dfb85046be5ce70c787f897b5d939e" || candidate.delivery.current_main_tree !== "57909c14bd7fc2867bd67b94ae0c9a4ad94ffb2c" || candidate.delivery.stacked_base_commit !== "e0b71ddbb4774e0b87ba3c7eabb2f4680179f43c" || candidate.delivery.stacked_base_tree !== "fa1d70d46d1f3f90e90ba96bb5e5b5feda7da21b" || candidate.delivery.stacked_base_pr !== 95 || candidate.delivery.gate !== "MA-09" || candidate.delivery.pre_delivery_verified_count !== 13 || candidate.delivery.post_delivery_candidate_count !== 14 || candidate.delivery.total_gate_count !== 15 || canonicalJson(candidate.delivery.closure_conditions) !== canonicalJson(EXPECTED_CLOSURE_CONDITIONS)) return false;
