...
export const TWENTY_SHARD_AGGREGATE_VERSION =
  "action_661j5r7_twenty_shard_aggregate_rebuild_v1";
...
export function buildTwentyShardAggregateRebuildV1({
  ...
  const projection = {
    aggregate_version: TWENTY_SHARD_AGGREGATE_VERSION,
    decision: "certified",
...
export function verifyTwentyShardAggregateRebuildV1(
  aggregate,
  inputs,
) {
  assertClosed(aggregate, FIELDS);
  const expected = buildTwentyShardAggregateRebuildV1(inputs);
...
export function persistTwentyShardAggregateRebuildV1({
  aggregate,
  column_acl_policy_files,
  historical_files,
  history_files,
  ...
  verifyTwentyShardAggregateRebuildV1(aggregate, {
    column_acl_policy_files,
    historical_files,
    history_files,
    relation_state_files,
  ...
  try {
    ...
    verifyTwentyShardAggregateRebuildV1(readback, {
      column_acl_policy_files,
      historical_files,
      history_files,
      relation_state_files,
