...
/**
 * One-use AI-02.16 deploy-preview receipt endpoint.
 *
 * It intentionally opens no database connection and invokes no provider,
 * evaluator, writer, route or adapter. The response contains only the exact
 * redacted AI-02.15 receipt fields; it never returns values, variable names,
 * user identity, deploy identity, URL or source material.
 */
