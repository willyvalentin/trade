...
- Canonical generated Supabase database types target selected: `lib/supabase-database.types.ts`.
- This path was selected because no existing generated DB type destination exists, it matches the fallback proposed by this plan, it is easy to import through the existing `@/*` alias, and it keeps generated Supabase DB types separate from handwritten execution-record and audit contracts.
- The file was not created in Action 794.
- Supabase type generation was not run in Action 794.
...
- The generated file includes `Database`, `execution_records`, `execution_record_audit_events`, and audit table `Row`, `Insert`, and `Update` types.
- Runtime client imports were not changed in Action 795.
...
## Action 776 - Generated Types Plan Dependency Update

- Generated execution-record and audit table types remain blocked until migrations are applied and proven.
- `20260614000000_create_execution_records.sql` is the prerequisite for generating remote-backed `public.execution_records` types.
- Audit table type generation remains blocked until `public.execution_records` and `public.execution_record_audit_events` are both applied and proven.
- No type generation, generated type edit, migration apply, remote SQL, service-role code, writer, route, route call, or runtime write path was added.
- Recommended next action: Action 777 - Request/Record Execution Records Prerequisite Migration Approval.

## Action 777 - Generated Types Plan Approval Gate

- Generated types remain blocked because prerequisite migration approval is missing.
- `20260614000000_create_execution_records.sql` must be approved, applied, and proven before execution-record generated type proof.
- Audit generated types remain later and separate.
- No type generation, generated type edit, migration apply, remote SQL, service-role code, writer, route, route call, or runtime write path was added.
- Recommended next action: Action 778 - Provide Execution Records Prerequisite Migration Approval.

## Action 778 - Generated Types Plan After Prerequisite Apply

- Execution-record prerequisite migration is applied according to migration status proof.
- Supabase type generation was not run and generated type files were not modified.
- Generated execution-record types remain a separate action, and audit generated types remain blocked until audit migrations are applied and proven.
- No service-role code, writer, route, route call, or runtime write path was added.
