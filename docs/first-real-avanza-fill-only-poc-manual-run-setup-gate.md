...
- Final pre-live review confirms the manual run setup gate remains ready.
...
- Added final harness local simulation above the manual run setup gate.
- Result status: `first_real_avanza_fill_only_poc_final_real_browser_fill_only_run_harness_simulation_added`.
- The simulation keeps manual setup proof required and local-only.
