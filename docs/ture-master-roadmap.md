...
| Agent Intelligence AI-02.15 | [Staging nonsecret preflight receipt admission](./ai-02.15-staging-nonsecret-preflight-receipt-admission.md) is completed on exact main as PR #383. It is provider-free and I/O-free and accepts only the fixed-redaction receipt for AI-02.14's three permitted facts. A later one-time Git deploy-preview proof reached its temporary function artifact but returned no admissible receipt and was fully cleaned | It does not admit a future one-shot adapter. The attempted preview produces no credential, owner, deploy, source-row or staging-access evidence; provider/evaluator invocation, deployment, persistence, evaluation, runtime, broker and production remain excluded. |
