...
| Current bounded workstream | Action 666IP selects a frozen local five-key receipt whose own `canonicalCommandDigest` data value is `undefined` | Preserve the comparator and runtime boundary while this isolated scalar-invalidity rejection is independently reviewed |
