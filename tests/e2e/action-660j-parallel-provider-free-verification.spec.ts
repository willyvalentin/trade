...
const foundationTests = [
  ...
  "tests/e2e/sv-c8-provider-rights-retention-reconciliation.spec.ts",
  ...
  "tests/e2e/sv-e4-internal-paper-replay-corpus.spec.ts",
  ...
  "tests/e2e/action-666iy-b03-staging-catalog-audit.spec.ts",
