...
function isAllowedAction320ImplementationFile(relativePath) {
  return (
...
function isForbiddenChangedFile(relativePath) {
  ...
  if (isAllowedAction320ImplementationFile(relativePath)) return false;
...
const uncommittedAction320Only =
  ...
  actionChangedFiles.every((relativePath) =>
    isAllowedAction320ImplementationFile(relativePath) ||
